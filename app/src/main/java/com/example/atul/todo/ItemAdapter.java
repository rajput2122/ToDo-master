...
public class ItemAdapter extends BaseAdapter {
    ...
    public void deleteItem(int position) {
        ...
        addItemToCompleted(arrayList.get(position).getTitle(), arrayList.get(position).getDate(), arrayList.get(position).getTime());
    ...
    //Delete item from database
    public void addItemToCompleted(String name, String date,String time) {
        DatabaseHelper databaseHelper = new DatabaseHelper(context);
        try {
            databaseHelper.insertDataIntoCompleted(name, date, time);
